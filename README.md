...
│   ├── paciente-avaliacao-postural-editor/ # Editor de marcação postural (simetrógrafo)
...
| `/pacientes/:pacienteId/avaliacao-fisioterapeutica/postural/:id/marcar` | Editor de marcação postural: grade, linha de prumo, marcação guiada e zoom |
