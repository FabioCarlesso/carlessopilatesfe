...
│   ├── paciente-calendario/        # Calendário mensal/semanal de sessões e aulas
...
- `src/app/pages/pacientes/paciente-calendario/paciente-calendario.component.spec.ts`
- `src/app/shared/utils/calendario.spec.ts`
